...
import { faBars, faSignOut, faSignIn, faHome, faCubes, faUser, faUsers, faFlaskVial, faUtensils, faScroll } from '@fortawesome/free-solid-svg-icons'
...
const DefaultLayout: React.FC<{
    ...
    function getMenu(): MenuProps['items'] {
        ...
        menu.push({
            key: '/fooditem',
            label: 'Manage FoodItem',
            icon: <FontAwesomeIcon icon={faScroll}></FontAwesomeIcon>,
